    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-5">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <label htmlFor="autoplay" className="text-sm font-medium text-foreground">
                {t('autoplay')}
              </label>
              <p className="text-xs text-muted-foreground">{t('autoplayDesc')}</p>
            </div>
            <Switch id="autoplay" checked={autoPlay} onCheckedChange={setAutoPlay} />
          </div>
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <label htmlFor="subtitles" className="text-sm font-medium text-foreground">
                {t('captions')}
              </label>
              <p className="text-xs text-muted-foreground">{t('captionsDesc')}</p>
            </div>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground mt-3">{t('qualityDesc')}</p>
        </CardContent>
      </Card>
