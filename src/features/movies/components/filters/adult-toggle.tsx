...
function AdultToggle() {
  ...
  return (
    <div className="flex items-center gap-2">
      <Switch id="adult-toggle" checked={checked} onCheckedChange={handleChange} />
      <Label htmlFor="adult-toggle" className="flex items-center gap-1.5 text-xs font-medium cursor-pointer">
        {checked ? (
